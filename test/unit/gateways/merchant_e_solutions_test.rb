...
class MerchantESolutionsTest < Test::Unit::TestCase
  ...
  def successful_verify_response
    'transaction_id=14da2c0f8435367c8aa08605e0e218d6&error_code=085&auth_response_text=Exact Match&avs_result=Y&cvv2_result=M&auth_code=T6951H'
  end

  def failed_verify_response
    'transaction_id=f4a63903d4d430e8bd5f49d3b40fbe29&error_code=014&auth_response_text=Card No. Error&avs_result=0&auth_code=000000'
  end
